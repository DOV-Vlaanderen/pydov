...
- We welcome [contributions](https://github.com/DOV-Vlaanderen/pydov/blob/hex_logo/CONTRIBUTING.rst) including bug reports.
- License: MIT
- Please note that this project is released with a [Contributor Code of Conduct](https://github.com/DOV-Vlaanderen/pydov/blob/hex_logo/CONDUCT.rst). By participating in this project you agree to abide by its terms.
