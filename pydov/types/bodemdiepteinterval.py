...
class Bodemdiepteinterval(AbstractDovType):
    ...
    fields = [
        ...
        WfsField(name='naam',
                 source_field='Naam',
                 datatype='string'),
        WfsField(name='bovengrens 1 (cm)',
                 source_field='Bovengrens1',
                 datatype='float'),
        WfsField(name='bovengrens 2 (cm)',
                 source_field='Bovengrens2',
                 datatype='float'),
        WfsField(name='bovengrenzen (cm)',
                 source_field='Bovengrenzen',
                 datatype='string'),
        WfsField(name='ondergrens 1 (cm)',
                 source_field='Ondergrens1',
                 datatype='float'),
        WfsField(name='ondergrens 2 (cm)',
                 source_field='Ondergrens2',
                 datatype='float'),
        WfsField(name='ondergrenzen (cm)',
                 source_field='Ondergrenzen',
                 datatype='string'),
        WfsField(name='ondergrens bereikt',
        ...
        WfsField(name='beschrijving',
                 ...
                 datatype='string'),
        WfsField(name='monsters',
                 source_field='Monsters',
                 datatype='string'),
        WfsField(name='monsterlijst',
                 source_field='Monsterlijst',
                 datatype='string'),
        WfsField(name='observaties',
                 source_field='Observaties',
                 datatype='string'),
        WfsField(name='observatielijst',
                 source_field='Observatielijst',
                 datatype='string'),
        WfsField(name='opmerkingen',
                 source_field='Opmerkingen',
                 datatype='string'),
        WfsField(name='opmerkinglijst',
                 source_field='Opmerkinglijst',
                 datatype='string'),
        WfsField(name='bodemlocatie',
                 source_field='Bodemlocatie',
                 datatype='string'),
