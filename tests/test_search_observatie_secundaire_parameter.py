...
from pydov.types.observatie import Observatie, ObservatieDetails, SecundaireParameter
from pydov.search.fields import ReturnFieldList
from pydov.util.dovutil import build_dov_url
from tests.abstract import AbstractTestSearch

location_md_metadata = 'tests/data/types/observatie_secundaire_parameter/md_metadata.xml'
location_fc_featurecatalogue = 'tests/data/types/observatie_secundaire_parameter/fc_featurecatalogue.xml'
location_wfs_describefeaturetype = 'tests/data/types/observatie_secundaire_parameter/wfsdescribefeaturetype.xml'
location_wfs_getfeature = 'tests/data/types/observatie_secundaire_parameter/wfsgetfeature.xml'
location_wfs_feature = 'tests/data/types/observatie_secundaire_parameter/feature.xml'
location_dov_xml = 'tests/data/types/observatie_secundaire_parameter/observatie.xml'
...
class TestObservatieSecundaireParameterSearch(AbstractTestSearch):
    ...
    def test_search_with_secundaire_parameters(self, mp_wfs, mp_get_schema,
                                               mp_remote_codelist,
        ...
        """
        search_type = Observatie.with_subtype(SecundaireParameter)
