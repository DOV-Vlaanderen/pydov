...
from tests.test_search_grondwaterlocatie import (
    wfs_getfeature,
    wfs_feature,
    mp_dov_xml,
...
class TestGrondwaterLocatie(AbstractTestTypes):
    """Class grouping tests for the
    pydov.types.grondwaterlocatie.GrondwaterLocatie class."""
    def get_type(self):
    ...
    def get_pkey_base(self):
        ...
        """
        return 'https://www.dov.vlaanderen.be/data/put/'
    ...
    def get_field_names_subtypes(self):
        ...
        """
        return ['beheerder_vanaf', 'beheerder_tot', 'beheerder']
    ...
    def get_valid_returnfields_subtype(self):
        ...
        """
        return ('pkey_grondwaterlocatie', 'gw_id', 'aquifer', 'beheerder')
